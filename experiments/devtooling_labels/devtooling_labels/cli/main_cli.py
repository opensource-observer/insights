...
@click.pass_context
def run_all_command(ctx, force_refresh_all, force_refresh_repos, force_refresh_summaries, force_refresh_categories):
    """Runs the entire pipeline: Fetch, Summarize, Categorize, Consolidate."""
    print("Executing: Run All Pipeline Steps")
