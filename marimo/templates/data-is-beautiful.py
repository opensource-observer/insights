...
def about_app(mo):
    mo.vstack([
        ...
        Note: this version is intended to serve as a template for creating data visualization dashboards with complex charting capabilities.
        """),
        mo.accordion({
            "<b>Click to see details on how app was made</b>": mo.accordion({
                ...
                - The visualization shows the top n projects based on total cumulative change
...
def generate_plot(
    ...
    fig = joyplot_timeseries(
        ...
        cmap_name=colormap_input.value.title(),
        fill_alpha=0.55,
...
@app.cell
def configuration_settings(mo, px):
