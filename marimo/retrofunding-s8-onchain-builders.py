...
def about_app(mo):
    mo.vstack([
        ...
        <small>Author: <span style="background-color: #f0f0f0; padding: 2px 4px; border-radius: 3px;">OSO Team</span> · Last Updated: <span style="background-color: #f0f0f0; padding: 2px 4px; border-radius: 3px;">2025-09-21</span></small>
        """),
        mo.md("""
...
def project_eligibility_table(
    ...
    mo.vstack([
        mo.md("---"),
        mo.md(f"### 🔴 {THIS_PERIOD} Eligibility"),
        show_project_eligibility_stats(),    
        show_project_eligibility_table()    
    ])
    return
