...
def about_app(mo):
    ...
    mo.vstack([
        ...
        """),
        mo.md("""
        This dashboard analyzes the top gas guzzlers on the Superchain, by project and chain.
        """),
        mo.accordion({
...
def generate_plot_trends(df_chains_filtered, mo, px):
    ...
    _fig = make_area_chart(df_chains_filtered, "Daily Gas Fee Trends by Chain")
    mo.ui.plotly(_fig)
    return
