...
def staking_nusers(blockchain: str, contract_address: str) -> str:
    return f"""
...
def staking_ntrxns(blockchain: str, contract_address: str) -> str:
    return f"""
...
def staking_sumtrxns(blockchain: str, contract_address: str) -> str:
    return f"""
