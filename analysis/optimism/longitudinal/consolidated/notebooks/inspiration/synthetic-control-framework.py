...
def define_constants():
    ...
    DEFAULT_TREATMENT = 'BASE'
    DEFAULT_CONTROLS = ['ARBITRUM_ONE', 'UNICHAIN', 'ZKSYNC_ERA', 'SCROLL', 'OPTIMISM', 'LINEA']
    DEFAULT_DEPENDENT = 'TVL - USD (Defillama)'
    DEFAULT_PREDICTORS = [
        #'TVS - Canonical (L2Beat)',
...
def configuration_settings(
    ...
    _intervention_date = '2025-04-15' #_end_date - timedelta(days=180)
    _training_months = 3
...
def get_chain_metrics(
    ...
    df_metrics = mo.sql(query, engine=pyoso_db_conn, output=False)
    return (df_metrics,)
