...
def rf5_scorer(ballots_data):
    ...
    results_dataframe = capped_allocations.copy().rename('rf5_rewards').reset_index()
...
def simulate_rf5_scorer(ballots_data, addresses):
    ...
    return rf5_scorer(filtered_data)
